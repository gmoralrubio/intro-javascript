...
const carritoCompra = [19.99, 45, 8.6]
...
const shoppingPrices = [29.99, 15.5, 8.99, 42.0, 12.5]

//   Calcula:

//   a) El total a pagar (suma de todos)
const totalPayment = shoppingPrices.reduce((acc, price) => (acc += price))
console.log(totalPayment)

//   b) El precio promedio
const promedio = totalPayment / shoppingPrices.length
console.log(promedio)

//   c) El producto más caro
const mostExpensive = Math.max(...shoppingPrices)
console.log(mostExpensive)

//   d) Cuántos productos cuestan más de 20€
const moreThan20 = shoppingPrices.filter(price => price > 20)
...
myPlaylist.unshift('Song Zero')
console.log(myPlaylist)

//   c) Verificar si 'Song B' está en la lista
const isInArray = myPlaylist.includes('Song B')
console.log(isInArray)

//   d) Encontrar la posición de 'Song C'
const indexOfC = myPlaylist.indexOf('Song C')
...
const blackKing = chessBoard[0][4]
...
const isPositionEmpty = chessBoard[2][2] === ' '
...
const prices = [29.99, 15.5, 8.99, 42.0, 12.5]
